...
bool Router::handleStaticRoute(const string& path, HttpRequest& request, HttpResponse& response) {
...
bool Router::handleDynamicRoute(const string& path, HttpRequest& request, HttpResponse& response) {
